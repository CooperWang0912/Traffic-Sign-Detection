...
def crop(input_image, sides):
    ...
    global height_start, height_end, width_start, width_end
    ...
    if input_image is None:
        ...
        if red_contour is None:
            ...
            height_start = contour_center[0] - sides
            height_end = contour_center[0] + sides
            width_start = contour_center[1] - sides
            width_end = contour_center[1] + sides
